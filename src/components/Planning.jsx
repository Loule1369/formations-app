...
// dans le planning (pas un problème de défilement — le déplacement d'un bloc y est même bloqué).
// Journée complète pour ne jamais bloquer un départ très tôt ou un retour très tard.
